    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.card}>
                ...
                <p className={styles.subtitle}>Please log into your account</p>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    >
                        {isLoading ? 'Sending...' : 'Log in via Email Magic Link'}
                    </button>
                </form>
                ...
                <p className={styles.signupLink}>
                    Don't have an account? <Link href="/pricing">Sign up now</Link>
                </p>
